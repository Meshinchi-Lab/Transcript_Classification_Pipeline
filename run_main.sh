...
nextflow \
    ...
    --alignment_reference_fasta /fh/fast/meshinchi_s/workingDir/scripts/lwallac2/Python/PacBio_LR_Initial_Investigation/Pigeon_Run_1/human_GRCh38_no_alt_analysis_set.fasta \
